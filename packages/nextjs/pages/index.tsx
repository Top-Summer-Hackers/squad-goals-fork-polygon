        ...
        <div className="max-w-[1980px] mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 w-[80%]">
          <div className="flex flex-col justify-center lg:w-[60%] mx-auto">
            <div className="mt-10 lg:mt-0 flex gap-2">
              ...
              <div className="text-lg font-semibold">
                Show your commitment by staking a specific amount of ETH. This cryptocurrency is securely locked in a
          ...
          <div className="flex flex-col justify-center lg:w-[60%] mx-auto">
            <div className="flex gap-2">
              ...
              <div className="text-lg font-semibold">
                ...
                votes, you&apos;ll not only reclaim your staked ETH but also win the stake lost by others, and bask in
